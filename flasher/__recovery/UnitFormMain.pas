...
{ ******************************************************* }
{ ±¾Èí¼þÊ¹ÓÃMITÐ­Òé. }
{ ·¢²¼±¾Èí¼þµÄÄ¿µÄÊÇÏ£ÍûËüÄÜ¹»ÔÚÒ»¶¨³Ì¶ÈÉÏ°ïµ½Äú. }
{ ±àÐ´Õß: Vowstar <vowstar@gmail.com>, NODEMCU¿ª·¢×é. }
{ ******************************************************* }
unit UnitFormMain;
...
{$J-}
  // ¸ß¾«¶ÈµÄÑÓÊ±£¬¾«È·µ½Ms , 100msÒÔÄÚ²ÉÓÃ£¬»òÒªÇóÎó²î¼«Ð¡
  // É¾³ýApplication.ProcessMessages Ó°Ïì¾«¶È
...
begin
  ...
  begin
    ...
    begin
      // MemoOutput.Lines.Add('Note:´®ÐÐ¶Ë¿Ú½ÓÊÕµ½Êý¾Ý.');
...
{$ENDIF}
      ...
      begin
        // MemoOutput.Lines.Add('Note:¶ÁÐ¾Æ¬¼Ä´æÆ÷³É¹¦.');
