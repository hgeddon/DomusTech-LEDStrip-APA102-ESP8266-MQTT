...
export IO_PLATFORMS='declare -A io_platforms=( [zero]="arduino:samd:arduino_zero_native", [m4wifi]="adafruit:samd:adafruit_metro_m4_airliftlite:speed=120", [esp8266]="esp8266:esp8266:nodemcuv2:eesz=4M2M,xtal=160,wipe=none" [esp32]="esp32:esp32:featheresp32:FlashFreq=80" )'
